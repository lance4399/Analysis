...
//		BufferedReader read=new BufferedReader(new FileReader("C:/Users/zzd/Desktop/ml-100k/u.data"));
		BufferedReader read=new BufferedReader(new FileReader("ratings.dat"));
		String str;
...
//				System.out.println(recommend);
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println(list.get(100).getUserId()+","+list.get(100).getMovieId()+","+list.get(100).getScore());
